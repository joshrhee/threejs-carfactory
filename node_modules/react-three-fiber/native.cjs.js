...
var useCanvas = function useCanvas(props) {
  ...
  var prepareRay = React.useCallback(function (event) {
    ...
    var offsets = (raycaster == null ? void 0 : raycaster.computeOffsets == null ? void 0 : raycaster.computeOffsets(event)) || event.nativeEvent;
  ...
  React.useLayoutEffect(function () {
    render( /*#__PURE__*/React__default['default'].createElement(Canvas, null, /*#__PURE__*/React__default['default'].createElement(stateContext.Provider, {
...
function useLoader(Proto, url, extensions, onProgress) {
  ...
  var results = useAsset.useAsset(loadingFn(extensions, onProgress), [Proto, url]); // Return the object/s

  return Array.isArray(url) ? results : results[0];
}

useLoader.preload = function (Proto, url, extensions) {
  return useAsset.useAsset.preload(loadingFn(extensions), Proto, url);
};
...
var IsReady = /*#__PURE__*/React.memo(function (_ref) {
  var gl = _ref.gl,
      props = _objectWithoutPropertiesLoose__default['default'](_ref, ["gl"]);
  ...
  return /*#__PURE__*/React.createElement(reactNative.View, _extends__default['default']({}, panResponder.panHandlers, {
    style: reactNative.StyleSheet.absoluteFill,
    collapsable: false
  }));
});
var Canvas = /*#__PURE__*/React.memo(function (props) {
  ...
  var onContextCreate = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator__default['default']( /*#__PURE__*/regeneratorRuntime.mark(function _callee(gl) {
  ...
  return /*#__PURE__*/React.createElement(reactNative.View, {
    onLayout: onLayout,
    style: _extends__default['default']({}, styles, props.style)
  }, size && /*#__PURE__*/React.createElement(expoGl.GLView, {
    nativeRef_EXPERIMENTAL: setNativeRef,
    onContextCreate: onContextCreate,
    style: reactNative.StyleSheet.absoluteFill
  }), size && renderer && /*#__PURE__*/React.createElement(IsReady, _extends__default['default']({}, props, {
    size: size,
    gl: renderer
  })));
});
